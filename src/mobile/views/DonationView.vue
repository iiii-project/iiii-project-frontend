...
.donation-main { width: min(1160px, calc(100% - 40px)); margin: 0 auto; padding: 58px 0 36px; }.eyebrow { margin: 0 0 12px; color: #a63a3a; font-size: 12.5px; font-weight: 600; letter-spacing: .3em; }
